...
def CASAPoseConditional1(
    ...
    **kwargs
    ...
    x = layers.Conv2D(seg_dim, (1, 1), strides=(1, 1), name="pv_final_conv_segmentation", **get_conv_params(), dtype=tf.float32)(x)
    ...
    y = layers.Conv2D(ver_dim, (1, 1), strides=(1, 1), name="pv_final_conv_vertex", **get_conv_params(), dtype=tf.float32)(y)
...
def PVNet(
    ...
    **kwargs
    ...
    x = layers.Conv2D(seg_dim + ver_dim, (1, 1), strides=(1, 1), name="pv_final_conv", **get_conv_params(), dtype=tf.float32)(x)
